    ...
    <div className="min-h-screen bg-gray-50 flex flex-col">
      ...
      >
        <div className="max-w-7xl mx-auto flex justify-between items-center">
          ...
          <motion.div
            whileHover={{ scale: 1.05 }}
            className="bg-gradient-to-r from-orange-400 to-yellow-400 text-white px-4 sm:px-6 py-3 rounded-full font-bold flex items-center gap-2 text-base sm:text-lg shadow-lg"
          >
